...
# process data
###############################################################################################################################
Q_station_names <- c("gnt07a_1066", "gnt05a_1066", "rup00a_1066","zes29f_1066", "zes00a_1066")
H_station_names <- c("gnt07a_1066", "gnt05a_1066", "BS_RUP_1095","zes28a_1066", "zes01a_1066")

for (i in 1:length(Q_station_names)) {
    temp <- get_velocity(Q_station_names[i], H_station_names[i], metadata)
    write.csv(temp, paste("C:/Code/WP1-grotenete-analysis/data/interim/processed/",H_station_names[i],"_V.csv", sep =""), row.names = FALSE)
}
